...
export default function UsersList() {
    ...
    const handleItemPress = useCallback((id: number) => navigation.push('User', {id}), [navigation]);
    ...
    const renderItem = useCallback(
        (item: TUser) => (
            <View key={item.id} style={styles.itemWrapper}>
                <UserItem onPress={handleItemPress} onRemove={handleRemoveUser} item={item} />
            </View>
        ),
        [handleRemoveUser, handleItemPress],
    );
